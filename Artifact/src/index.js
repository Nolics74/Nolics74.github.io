...
const game = (() => {
  ...
  let players = [player(0,"Radiant",
                    ["Debbi the Cunning","Keefe the Bold","Fahrvhan the Dreamer","J\'Muy the Wise","Sven"],//Axe
                    deck.slice()),
                 player(1,"Dire",
                    ["Debbi the Cunning","Keefe the Bold","Fahrvhan the Dreamer","J\'Muy the Wise","Sven"],
                    deck,
                    true)];
